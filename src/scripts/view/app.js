...
class App {
  ...
  async renderPage() {
    ...
    if (!page) {
      // Render halaman Not Found jika route tidak ditemukan
      this.#content.innerHTML = `<div class="not-found-page"><h2>404 - Halaman Tidak Ditemukan</h2><p>Maaf, halaman yang Anda cari tidak tersedia.</p></div>`;
      return;
    }
